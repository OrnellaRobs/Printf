...
#    Updated: 2017/04/21 18:45:51 by orazafin         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memcmp.c\
	...
	ft_count_word.c ft_is_space.c ft_intlen.c ft_create_elem.c\
	ft_strcapitalize.c ft_is_upper.c ft_is_lower.c ft_list_push_back.c\
	get_next_line.c\
